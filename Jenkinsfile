pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/mosinsmj-225'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/mosinskimatt/225-lab3-2.git'                   // <------change this
        KUBECONFIG = credentials('mosinsmj-225')                                             // <------change this
    }
